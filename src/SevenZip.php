...
use Verseles\SevenZip\Contracts\ArchiveInterface;
use Verseles\SevenZip\Contracts\CompressorInterface;
use Verseles\SevenZip\Contracts\ExtractorInterface;
use Verseles\SevenZip\Contracts\TesterInterface;
use Verseles\SevenZip\Exceptions\ExecutableNotFoundException;

class SevenZip implements ArchiveInterface, CompressorInterface, ExtractorInterface, TesterInterface {
    /**
     ...
     * @param string|null $value The value for the flag (optional).
     ...
     *
     * @return array<string, string|null> The custom compression flags that have been added.
     */
     ...
     *
     * @param array<string, string|null> $customFlags The custom compression flags to be used.
     *
     * @return static The current instance of the SevenZip class.
     */
     ...
     *
     * @return static Returns the current instance of this class.
     */
    public function encrypt(string $password) : static {
     ...
     * @return static
     */
    public function notEncryptNames() : static {
     ...
     *
     * @param string|array<int, string> $fileRefs   File references to exclude. Can be a wildcard pattern or a list file.
     ...
     * @param string|array<int, string> $fileRefs   File references to add. Can be a wildcard pattern or a list file.
     * @param bool|int                  $recursive  Recurse type. Can be: true for 'r' (enabled), false for 'r-' (disabled), 0 for 'r0' (enabled for wildcards)
     * @param bool                      $isListFile Whether the file reference is a list file
     *
     * @return static
     ...
     *
     * @param string|array<int, string> $fileRefs   File references to include. Can be a wildcard pattern or a list file.
     * @param bool|int                  $recursive  Recurse type. Can be: true for 'r' (enabled), false for 'r-' (disabled), 0 for 'r0' (enabled for wildcards)
     * @param bool                      $isListFile Whether the file reference is a list file
     *
     * @return static
     ...
     *
     * @param array<int, string|null> $command The 7-Zip command to be executed.
     * @param bool                    $secondary Whether this is a secondary command.
     *
    ...
    protected function parseProgress(string $output) : void {
        ...
        foreach ($lines as $line) {
            if (preg_match("/(\d+)%\s+\d+/", $line, $matches)) {
                ...
                $progress = (int) floor($progress / $this->getDivideProgressBy());
    ...
    public function setDivideProgressBy(int $number = 1) : static {
        $this->divideProgressBy = $number > 0 ? $number : 1;
     ...
     * @return static The current instance of the SevenZip class.
     */
    protected function setLastProgress(int $value) : static {
     ...
     *
     * @param string|array<int, string> $extensions The extension or an array of extensions to check.
     *
     ...
     *
     * @param array<int, array<string, mixed>>|null $formats The array of format data. If not provided, the built-in info will be used.
     *
     * @return array<int, string> The array of supported format extensions.
     */
     ...
     *
     * @return array<string, mixed> The parsed data with version, formats, codecs, and hashers.
     */
     ...
     * @return static The current instance of the SevenZip class.
     */
    public function tarBefore(bool $keepFileInfo = TRUE) : static {
        return $this
          ->forceTarBefore(TRUE)
     ...
     *
     * @return array<string, mixed> An array containing 'info' and 'files' keys with the archive information and file list.
     * @throws \InvalidArgumentException If the source path is not set.
     */
     ...
     *
     * @param array<int|string, string|null> $array An associative array of flags and their corresponding values.
     *                                               If the value is null, the flag will be added without an equal sign.
     *
     * @return array<int, string> An array of formatted flag strings.
     */
     ...
     *
     * @return array<int|string, string> The array of flags that are always used when running 7-Zip commands.
     */
     ...
     *
     * @param array<int|string, string> $alwaysFlags The array of flags that are always used when running 7-Zip commands.
     *
     * @return static The current instance of the SevenZip class.
     */
     ...
     * @param array<int, string|null> $extractCommand
     *
     * @return string
     */
     ...
     * @return static
     */
    public function mm(string $method) : static {
     ...
     * @return static The current instance of the SevenZip class.
     */
    protected function executeTarBefore() : static {
     ...
     * @return static
     */
    public function deleteSourceAfterCompress() : static {
        return $this->sdel();
    }
     ...
     *
     * @return array<int|string, string> The default compression flags for the specified format.
     */
    ...
    public function mx(int $level) : static {
        ...
        return $this->addFlag('mx', (string) $level);
    }
     ...
     * @return static The current instance of the SevenZip class.
     */
    public function mmem(int|string $size = 24) : static {
        return $this->addFlag('mmem', (string) $size);
    }
    ...
    public function mpass(int $number = 7) : static {
        ...
        return $this->addFlag('mpass', (string) $number);
    }
    ...
    public function mfb(int $bytes = 64) : static {
        ...
        return $this->addFlag('mfb', (string) $bytes);
    }
     ...
     *
     * @param string $method The compression method to be used.
     *
     * @return static
     */
    public function m0(string $method) : static {
     ...
     * @return static
     */
    public function m2(string $method) : static {
     ...
     * @return static The current instance of the SevenZip class.
     */
    public function solid(bool|string|int $on = TRUE) : static {
        return $this->ms($on);
    }
    ...
    public function myx(int $level = 5) : static {
        return $this->addFlag('myx', (string) $level);
    }
    ...
    public function test() : bool {
        return $this->testWithDetails()['valid'];
    }

    /**
     * Test the integrity of an archive and return detailed information.
     *
     * @return array<string, mixed> An array containing test results with 'valid', 'output', and 'files' keys.
     *
     * @throws \InvalidArgumentException If the source path is not set.
     */
    public function testWithDetails() : array {
        ...
        if ($valid) {
            $lines = explode("\n", $output);
            foreach ($lines as $line) {
                if (preg_match('/^T\s+(.+)$/', trim($line), $matches)) {
                    $testedFiles[] = trim($matches[1]);
                }
            }
        }
